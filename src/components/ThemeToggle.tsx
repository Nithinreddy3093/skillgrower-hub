      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button 
            ...
            size="icon" 
            onClick={toggleTheme}
            className="rounded-full w-9 h-9 transition-colors border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 shadow-sm"
